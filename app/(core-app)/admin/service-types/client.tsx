...
export function ServiceTypesClient({ serviceTypes }: ServiceTypesClientProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Service Types</h1>
          <p className="text-slate-600 mt-1">Manage the types of services your laundry offers.</p>
        </div>
        <ServiceTypeDialog>
      ...
      <Card className="border-0 shadow-card">
        <CardHeader className="pb-4">
          <CardTitle className="text-lg font-semibold text-slate-900">All Service Types ({table.getFilteredRowModel().rows.length})</CardTitle>
        </CardHeader>
        <CardContent className="pt-0">
          <Table>
            <TableHeader>
